...
def _register_ft_rdzv_handler():
    ...
    from nvidia_resiliency_ext.fault_tolerance._ft_rendezvous import FtRendezvousHandler, create_handler
    from nvidia_resiliency_ext.fault_tolerance._torch_elastic_compat.rendezvous import rendezvous_handler_registry
    from nvidia_resiliency_ext.fault_tolerance._torch_elastic_compat.rendezvous.c10d_rendezvous_backend import create_backend
